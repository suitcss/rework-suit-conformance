...
function validateCustomProperties(rules, componentName) {
  rules.forEach(function (rule) {
    ...
    rule.declarations.forEach(function (declaration) {
      ...
      if (property.indexOf('var-') !== 0) {
        throw new Error(
          'Invalid custom property "' + property + '" near line ' + line + ':' + column + '. ' +
          'Component `:root` rule must only contain custom properties.'
        );
      }
      if (property.indexOf(componentName) === -1) {
        throw new Error(
